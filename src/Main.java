public class Main {
    public static void main(String[] args) {
       Author shattam = new Author("Максим","Шаттам");
        ...
        System.out.println("Название :"+igrirazuma.getName());
        System.out.println("Год выпуска "+igrirazuma.getEst());
        System.out.println(" ");
        System.out.println("Автор "+barto.getNameAuthor()+" "+barto.getSurnameAuthor());
        System.out.println("Название "+stihi.getName());
        System.out.println("Год выпуска "+ stihi.getEst());
